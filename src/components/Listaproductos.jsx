...
function Listaproductos(props){
    ...
    useEffect(() => {
        ...
        axios({
            method: "get",
            url: "https://salty-springs-00842.herokuapp.com/listaproductos",
    ...
    function añadirElemento(event){
        ...
        if (modificarActivado === false){
            ...
            axios({
                method: "post",
                url:"https://salty-springs-00842.herokuapp.com/listaproductos/add",
                headers: {"x-access-token": props.tokenUsuario},
                data: nuevoItem  
            })
            .then(function(res){
            ...
            axios({
                method: "post",
                url:"https://salty-springs-00842.herokuapp.com/listaproductos/actualizar/"+ datosMoficar.id,
                headers: {"x-access-token": props.tokenUsuario},
                data: datosMoficar 
            })
            .then(function(res){
    ...
    function borrarElemento(_id){
        ...
        axios({
            method: "delete",
            url:"https://salty-springs-00842.herokuapp.com/listaproductos/borrar/"+ _id,
            headers: {"x-access-token": props.tokenUsuario},
        })
        .then(function(res){
            console.log(res);
